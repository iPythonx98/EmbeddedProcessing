...
set_property PACKAGE_PIN U9 [get_ports sw_8bit_tri_i[0]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[0]]
#Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports sw_8bit_tri_i[1]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[1]]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports sw_8bit_tri_i[2]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[2]]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports sw_8bit_tri_i[3]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[3]]
#Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports sw_8bit_tri_i[4]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[4]]
#Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports sw_8bit_tri_i[5]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[5]]
#Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports sw_8bit_tri_i[6]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[6]]
#Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports sw_8bit_tri_i[7]]					
	set_property IOSTANDARD LVCMOS33 [get_ports sw_8bit_tri_i[7]]
...
set_property PACKAGE_PIN E16 [get_ports btns_5bit_tri_i[0]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btns_5bit_tri_i[0]]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports btns_5bit_tri_i[1]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btns_5bit_tri_i[1]]
#Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports btns_5bit_tri_i[2]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btns_5bit_tri_i[2]]
#Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports btns_5bit_tri_i[3]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btns_5bit_tri_i[3]]
#Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports btns_5bit_tri_i[4]]						
	set_property IOSTANDARD LVCMOS33 [get_ports btns_5bit_tri_i[4]]
...
##USB-RS232 Interface
##Bank = 35, Pin name = IO_L7P_T1_AD6P_35,					Sch name = UART_RXD_IN
set_property PACKAGE_PIN C4 [get_ports uart_rxd]						
	set_property IOSTANDARD LVCMOS33 [get_ports uart_rxd]
##Bank = 35, Pin name = IO_L11N_T1_SRCC_35,					Sch name = UART_TXD_OUT
